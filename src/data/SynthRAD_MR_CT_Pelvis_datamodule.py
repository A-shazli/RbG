...
#     dataset_SynthRAD,
#     # dataset_SynthRAD_CT_CBCT_pelvis
# )
from TEST_PREPROCESSINg import  dataset_SynthRAD
class SynthRAD_MR_CT_Pelvis_DataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.data_train = dataset_SynthRAD(
            ...
            denoise=True,
            sharpen=True,
            rigid_register=False,  # 🔄 Enable Rigid Registration
            hist_match=True,  # 📊 Enable Histogram Matching
            apply_mask=True,  # 🛑 New flag to apply mask
