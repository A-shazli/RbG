...
def register_pair(
    ...
    print("Shape of identity map: ", shape)
    ...
    print("shape A before resize", A_trch.shape)
    A_resized = F.interpolate(
        A_trch, size=shape[2:], mode="trilinear", align_corners=False
    )
    print("shape A after resize", A_resized.shape)
    ...
    # print(model.fullres_net.identity_map, "IDENTITY MAP")
    # print(type(model.fullres_net.identity_map), "IDENTITY MAP type")
    ...
    print("Shape of phi_AB", phi_AB.shape)
